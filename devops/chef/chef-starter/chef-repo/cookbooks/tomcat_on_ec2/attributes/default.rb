case node['platform']
  when 'ubuntu', 'debian'
    ...
    default['tomcat_on_ec2']['deploy_location'] = '/var/lib/tomcat7/webapps/jenkins.war'
  ...
  when 'rhel', 'centos'
    ...
    default['tomcat_on_ec2']['deploy_location'] = '/usr/share/tomcat/webapps/jenkins.war'
end
...
default['tomcat_on_ec2']['jenkins'] = "http://ftp.yz.yamagata-u.ac.jp/pub/misc/jenkins/war-stable/2.46.2/jenkins.war"